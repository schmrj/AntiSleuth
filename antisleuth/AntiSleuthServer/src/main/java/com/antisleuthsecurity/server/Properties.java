...
public class Properties {
	...
	public String getProperty(PropsEnum property) {
		if (config != null)
			return (String) this.config.getProperty(property.getProperty());
		else
			return (String) this.servletConfig.getInitParameter(property.getProperty());
	}
